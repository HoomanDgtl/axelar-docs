...
- Golang
- [Official Documentation](https://docs.kava.io/docs/nodes-and-validators/validator-node/)
...
<tab-item title="Mainnet">
 <pre><code>git checkout [release tag]</code></pre>
...
<tabs>
<tab-item title="Mainnet">
 <pre><code>kava init [your_moniker_name] --chain-id kava_2222-10</code></pre>

</tab-item>
<tab-item title="Testnet">
 <pre><code>kava init [your_moniker_name] --chain-id kava_2221-16000</code></pre>
...
<tabs>
<tab-item title="Mainnet">
 <pre><code>wget https://kava-genesis-files.s3.us-east-1.amazonaws.com/kava_2222-10/genesis.json</code></pre>

</tab-item>
<tab-item title="Testnet">
 <pre><code>wget https://raw.githubusercontent.com/Kava-Labs/kava-testnets/master/16000/genesis.json</code></pre>
...
<tabs>
<tab-item title="Mainnet RPC">
 <pre><code>https://kava-mainnet.chainode.tech:443</code></pre>

</tab-item>
<tab-item title="Testnet RPC">
 <pre><code>https://kava-testnet.chainode.tech:443</code></pre>
